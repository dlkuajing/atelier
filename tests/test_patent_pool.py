...
REPORT_PATH = ROOT / ".planning/loop/uspto-b4-report.md"
...
def test_uspto_batch4_report_records_query_stats() -> None:
    if not REPORT_PATH.is_file():
        pytest.skip("DATA-05a collection report is optional outside the collection worktree")
