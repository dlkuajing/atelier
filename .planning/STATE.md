...
| `260715-patent-generic-summary-metadata-parser` | active-next-layout | Strict before census 294 items/294 roots. Layouts 1--17, four source-terminal publications, and four exact-raster Ability PDF profiles are replayed append-only. `US-11231565-B2:e1` is terminal `metadata_unpublished`; `US-11175479-B2` retains three parser items and `US-20200201001-A1` retains two, all below unchanged OCR gates. TIFF container-padding nondeterminism is removed by canonical decoded-raster hashing. Attempts 2/3 for the newest root have identical evidence/results and launch no worker. Generic bucket is 257, result set `a8158974...eea3`, summary `e29f5e05...769e`, and audit is 619/619 corrupt=0. Continue the largest measured parser bucket without promoting staging. |
