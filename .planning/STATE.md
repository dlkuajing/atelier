...
| `260715-patent-local-pool-replay` | active-328-of-619-saturation-incomplete | Frozen cohort SHA `e809823c...b42b`; strict checkpoint 328/619, corrupt=0. Current item census: parser review 863, receipt terminal 346, staging pending intake 127, patent-budget retry 8. Largest interim parser signatures: Sunny metadata missing 243, generic summary metadata missing 134, AAC Raytech summary metadata missing 95, and Sunny surface value non-numeric 91. Continue the full frozen replay; do not select a final parser bucket or claim saturation from this partial sample. |
