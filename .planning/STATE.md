...
| Patent saturation | ACTIVE / INCOMPLETE. Frozen 619-root local replay remains strict with missing=0 and corrupt=0. Current evidence has 420 parser-review roots, 139 mixed roots, 518 staging items, and 28 conversion-retry items. Exact-raster PDF recovery now also splits `US-12449639-B2` into three source-bound Largan prescription failures at unchanged OCR gates; generic-summary remains the largest parser bucket at 253 roots. This is not source/global saturation. |
