...
| `260715-patent-local-pool-replay` | active-228-of-619-saturation-incomplete | Frozen cohort SHA `e809823c...b42b`; strict checkpoint 228/619, corrupt=0. Current item census: parser review 661, receipt terminal 303, staging pending intake 85, patent-budget retry 1. Largest interim parser signatures: Sunny metadata missing 202, Sunny surface value non-numeric 81, generic summary metadata missing 72, and AAC Raytech summary metadata missing 63. Continue the full frozen replay; do not select a final parser bucket or claim saturation from this partial sample. |
