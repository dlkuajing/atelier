...
| `260715-patent-local-pool-replay` | active-428-of-619-saturation-incomplete | Frozen cohort SHA `e809823c...b42b`; strict checkpoint 428/619, corrupt=0. Current item census: parser review 1051, receipt terminal 436, staging pending intake 217, patent-budget retry 12. Largest interim parser signatures: Sunny metadata missing 285, generic summary metadata missing 188, Sunny surface value non-numeric 108, and AAC Raytech summary metadata missing 100. Continue the full frozen replay; do not select a final parser bucket or claim saturation from this partial sample. |
