...
| Patent saturation | ACTIVE / INCOMPLETE. Frozen 619-root local replay remains strict with missing=0 and corrupt=0. Current evidence has 420 parser-review roots, 139 mixed roots, 518 staging items, and 28 conversion-retry items. Exact-raster Ability PDF recovery now also classifies all four `US-10809497-B2` prescriptions as source-proven `metadata_unpublished.system_f_number_absent`; generic-summary remains the largest parser bucket at 254 roots. This is not source/global saturation. |
