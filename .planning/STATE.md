...
| Patent saturation | ACTIVE / INCOMPLETE. Frozen 619-root local replay remains strict with missing=0 and corrupt=0. After Ability official-PDF exact-image OCR recovery: 423 parser-review roots, 139 mixed roots, 518 staging items, and 28 conversion-retry items remain non-terminal. The largest parser bucket remains `generic_summary_metadata_missing=260`; this is not source/global saturation. |
