...
| Patent saturation | ACTIVE / INCOMPLETE；619-root frozen local replay remains strict with missing=0 and corrupt=0. After generic-summary layout 1: 445 parser-review roots, 125 mixed roots, 455 staging items, and 28 patent-budget retry items remain non-terminal. The largest parser bucket remains `generic_summary_metadata_missing=286`; this is not source/global saturation. |
...
| `260715-patent-generic-summary-metadata-parser` | active-next-layout | Strict before census 294 items/294 roots. Layout 1 replayed 8 roots/58 embodiments: generic bucket 294→286, with 26 staging + 26 terminal + 6 parser rejects. Result set `f0e4e3c1...4dc8`, audit 619/619 corrupt=0. Select next exact layout from remaining 286. |
