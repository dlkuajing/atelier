...
- Current replay checkpoint: 228/619 roots, 0 corrupt results. This is an intermediate checkpoint,
  not replay completion or saturation.
- Current root states: parser review 165, mixed non-terminal 51, source retry 3, all-terminal 7,
  all-converted-pending-intake 2.
- Current item states: parser review 661, terminal receipt 303, converted-pending-intake 85,
  patent-budget retry 1.
- Parser signatures are recomputed from strict result detail. Current largest measured signatures
  are Sunny metadata missing (202), Sunny surface value non-numeric (81), generic summary metadata
  missing (72), and AAC Raytech summary metadata missing (63); the full cohort must finish before
  selecting the final largest parser bucket.
