...
- Family ID: `45593888`
- Root / publication: `US-8218254` / `US-8218254-B2`
- Application: `12/861419`
- Title: `SOLID IMAGING OBJECTIVE AND ASSEMBLY TECHNIQUE FOR SMALL SCALE SENSOR APPLICATIONS`
- Inventors: `Bareau; Jane L.`; `Milks; James D.`; `Alvez; Nidia A.`;
  `Lupien; Teresa M.`
- Assignee: `Gyrus ACMI, Inc.`
- Raw HTML:
  `data/patent-lake/uspto-ppubs-html/USPAT/a56aad055aba203f/US-8218254-B2.html`
- Raw bytes / SHA-256: `43375` /
...
- Entry marker scan: EFL=0, embodiment=1, example=1, F-number=0,
  full-field=0, half-field=0, queue table count=0. These counts are routing
  observations only, not a source denominator, prescription or outcome.
- Completed pre-change generic residual: 40 roots/items, result set
  `9eb5c733f33af1c398c79ee7a037d49329292765c079bb6a68d844cd866e790d`;
  the before census is copied byte-for-byte from completed Family 95825866
  after census at SHA-256
  `e04294185d1c20d8834aeb46b3bdfcc19303a5da579ebe6e7ec57e7d2e063614`.

## Objective

Independently reconcile the exact retained official B2, its application/family and
priority lineage, every disclosed solid imaging objective, manufacturing/assembly
method, endoscope or other system item, claim, figure, formula and inline data block;
establish the complete source-item and prescription denominator independently of queue
marker counts; bind every optical coordinate and required system datum only to the exact
item that directly publishes it; then implement only source-proven conversion or precise
