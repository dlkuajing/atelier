# Quick Plan: Patent generic family 95825866
...
- Family ID: `95825866`
- Root / publication: `US-20260079328` / `US-20260079328-A1`
- Application: `19/402617`
- Title: `IMAGING LENS ASSEMBLY, CAMERA MODULE, AND IMAGING DEVICE`
- Applicant: `GUANGDONG OPPO MOBILE TELECOMMUNICATIONS CORP., LTD.`
- Raw HTML:
  `data/patent-lake/uspto-ppubs-html/US-PGPUB/ae961898207c571c/US-20260079328-A1.html`
- Raw bytes / SHA-256: `136101` /
...
- Entry marker scan: EFL=11, embodiment=0, example=0, F-number=54,
  full-field=2, half-field=0, queue table count=15. These counts are routing
  observations only, not a source denominator, prescription or outcome.
- Completed pre-change generic residual: 41 roots/items, result set
  `e2a1e5960a20d5cbdc26597ed1bc42d8689f1266f9f99f15e1803b25f8c0da64`;
  the before census is copied byte-for-byte from completed Family 87845869
  after census at SHA-256
  `3152b8408136095f48e76ae8f3804685856792871008f9468387724944dadfdd`.

## Objective

Independently reconcile the exact retained official A1, its application/family and
priority lineage, every disclosed imaging-lens assembly, camera-module and imaging-device
item, table, formula, claim and figure; establish the complete source-item and prescription
denominator independently of queue marker counts; bind every optical coordinate and required
system datum only to the exact item that directly publishes it; then implement only
source-proven conversion or precise terminal/nonterminal outcomes and close the root by
append-only deterministic replay without weakening any saturation invariant.

## Work plan

- [x] Open this GSD quick before detailed source investigation or code edit and freeze
  the exact completed entry snapshot.
- [x] Copy the current 41-family generic residual census byte-for-byte and record the
