# Quick Plan: Patent generic family 97226661
...
- Family ID: `97226661`
- Root / publication: `US-20260043988` / `US-20260043988-A1`
- Application: `19/046138`
- Title: `IMAGING LENS SYSTEM`
- Inventors: `KIM; Hag Chul`; `CHO; Seong Il`
- Applicant / assignee: `Samsung Electro-Mechanics Co., Ltd.`
- Raw HTML:
  `data/patent-lake/uspto-ppubs-html/US-PGPUB/bde68afa0fbd460a/US-20260043988-A1.html`
- Raw bytes / SHA-256: `147944` /
  `bde68afa0fbd460a1fb0fbe97e617072175a3a315b0e787ffa68a3d3ce4b4d5d`
- Layout signature:
  `9e29ef7be47f5fcf3ab4ac39838ec1283da4f914d53e327c9946796cc692134a`
...
- Entry marker scan: EFL=0, embodiment=40, example=0, F-number=4,
  full-field=2, half-field=0, queue table count=26. These counts are routing
  observations only, not a source denominator, prescription or outcome.
- Completed pre-change generic residual: 45 roots/items, result set
  `70528f6a028fa5b8d9fcd75eb4fa2d3f01ad76bd9544a4529aa6b931b36e393b`;
  the before census is copied byte-for-byte from completed Family 95563451 after
  census at SHA-256
  `0af3b215a58a7e76b3d75933ec20c316a1e8d19195f4b9c5a33f788ba76f438f`.
...
- [x] Copy the current 45-family generic residual census byte-for-byte and record the
