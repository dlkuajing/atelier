...
- result_set_sha256: `feeb0e16f34a49567a8a24b552b45e14a430bea2c4e54fda921eb3282f04b337`
- missing_roots: 0
- corrupt_results: 0
...
- `terminal.all_disclosed_items_terminal`: 241
- `parser_review_required.all_disclosed_items_rejected`: 191
...
- `terminal.confirmed_no_prescription.electronic_device_wrapper_only`: 54
...
- `terminal.confirmed_no_prescription.freeform_tir_display_architecture_only`: 27
- `terminal.metadata_unpublished.prescription_specific_angular_field_absent`: 27
- `terminal.confirmed_no_prescription.optical_lens_composition_and_antireflective_coating_material_data_only`: 26
- `terminal.confirmed_no_prescription.lens_barrel_absorbing_geometry_only`: 21
- `terminal.confirmed_no_prescription.mechanical_lens_module_geometry_only`: 21
- `terminal.metadata_unpublished.stop_axial_coordinate_absent`: 17
...
- `terminal.confirmed_no_prescription.antireflective_coating_layer_and_reflectance_test_data_only`: 12
...
- `terminal.confirmed_no_prescription.light_absorbing_material_spectral_data_only`: 11
...
- `terminal.metadata_unpublished.system_stop_angular_field_absent_and_image_height_raster_only`: 10
...
- `terminal.confirmed_no_prescription.freeform_reflective_hmd_architecture_only`: 9
- `terminal.confirmed_no_prescription.plastic_optical_element_gate_vestige_and_nozzle_geometry_only`: 9
- `terminal.confirmed_no_prescription.polygonal_light_passing_hole_and_lens_holding_member_architecture_only`: 9
- `terminal.metadata_unpublished.configuration_hfov_and_qcon_q6_definition_absent`: 9
- `terminal.confirmed_no_prescription.camera_module_wrapper_only`: 8
- `terminal.confirmed_no_prescription.electronic_device_deployment_wrapper_only`: 8
- `terminal.confirmed_no_prescription.light_blocking_sheet_mechanical_architecture_only`: 8
...
- `terminal.confirmed_no_prescription.light_blocking_sheet_and_lens_placement_architecture_only`: 6
...
- `terminal.confirmed_no_prescription.antireflective_nanostructure_air_gap_geometry_only`: 4
- `terminal.confirmed_no_prescription.electronic_device_camera_module_wrapper_only`: 4
- `terminal.confirmed_no_prescription.folded_camera_module_architecture_only`: 4
- `terminal.confirmed_no_prescription.imaging_lens_assembly_low_reflective_cluster_layer_architecture_only`: 4
- `terminal.confirmed_no_prescription.imaging_lens_assembly_mechanical_placement_architecture_only`: 4
- `terminal.confirmed_no_prescription.imaging_lens_spacing_ring_and_blocking_sheet_geometry_only`: 4
...
- `terminal.confirmed_no_prescription.plastic_optical_folding_reflective_film_architecture_only`: 4
- `terminal.confirmed_no_prescription.projection_light_beam_transmission_method_only`: 4
- `terminal.confirmed_no_prescription.projection_light_source_architecture_only`: 4
- `terminal.confirmed_no_prescription.roughened_lens_element_manufacturing_and_assembly_architecture_only`: 4
- `terminal.metadata_unpublished.adhesive_layer_refractive_index_and_dispersion_and_absolute_image_height_absent`: 4
- `terminal.metadata_unpublished.angular_field_half_full_semantics_absent`: 4
- `terminal.metadata_unpublished.ordered_surface_numeric_characters_missing_or_illegible_when_filed`: 4
...
- `terminal.confirmed_no_prescription.camera_module_actuator_architecture_only`: 3
- `terminal.confirmed_no_prescription.dual_molded_lens_light_absorbing_architecture_only`: 3
- `terminal.confirmed_no_prescription.electronic_device_camera_module_integration_wrapper_only`: 3
- `terminal.confirmed_no_prescription.electronic_device_camera_placement_architecture_only`: 3
- `terminal.confirmed_no_prescription.electronic_device_multi_camera_module_wrapper_only`: 3
- `terminal.confirmed_no_prescription.extended_depth_of_focus_phase_element_architecture_only`: 3
- `terminal.confirmed_no_prescription.folded_telephoto_smartphone_wrapper_only`: 3
- `terminal.confirmed_no_prescription.image_capturing_unit_wrapper_only`: 3
- `terminal.confirmed_no_prescription.lens_barrel_lens_element_fitting_and_bearing_architecture_only`: 3
- `terminal.confirmed_no_prescription.lens_barrel_retaining_glue_void_architecture_only`: 3
- `terminal.confirmed_no_prescription.multi_camera_smartphone_wrapper_only`: 3
- `terminal.confirmed_no_prescription.plastic_light_folding_reflective_film_architecture_only`: 3
- `terminal.confirmed_no_prescription.projection_system_architecture_only`: 3
...
- `terminal.metadata_unpublished.system_angular_field_absent`: 3
...
- `terminal.confirmed_no_prescription.imaging_apparatus_wrapper_only`: 2
...
- `terminal.confirmed_no_prescription.long_wavelength_absorbing_and_filtering_architecture_only`: 2
...
- `terminal.confirmed_no_prescription.optical_folding_component_variant_only`: 2
- `terminal.confirmed_no_prescription.optical_lens_architecture_and_chief_ray_path_only`: 2
- `terminal.confirmed_no_prescription.plastic_lens_optical_inspection_and_assembly_architecture_only`: 2
- `terminal.confirmed_no_prescription.projection_imaging_module_light_blocking_architecture_only`: 2
- `terminal.confirmed_no_prescription.second_projection_lens_schematic_materials_and_performance_only`: 2
- `terminal.confirmed_no_prescription.second_relay_lens_schematic_materials_and_performance_only`: 2
- `terminal.confirmed_no_prescription.smartphone_multi_camera_module_wrapper_only`: 2
...
- `terminal.confirmed_no_prescription.vehicle_camera_coverage_wrapper_only`: 2
- `terminal.confirmed_no_prescription.vehicle_device_wrapper_only`: 2
- `terminal.confirmed_no_prescription.vehicle_multi_camera_wrapper_only`: 2
- `terminal.confirmed_no_prescription.vehicle_wrapper_only`: 2
...
- `terminal.metadata_unpublished.prescription_specific_efl_f_number_angular_field_and_absolute_image_height_absent`: 2
...
- `terminal.metadata_unpublished.unlabeled_asphere_surface_binding_and_absolute_image_height_and_angular_field_absent`: 2
- `terminal.confirmed_no_prescription.aiming_intensity_at_second_near_working_distance_only`: 1
- `terminal.confirmed_no_prescription.aiming_pattern_subportion_spacing_architecture_only`: 1
- `terminal.confirmed_no_prescription.alternate_dual_axis_wiring_architecture_only`: 1
- `terminal.confirmed_no_prescription.alternate_flexible_wire_plate_architecture_only`: 1
- `terminal.confirmed_no_prescription.alternate_resilience_wiring_sheet_architecture_only`: 1
- `terminal.confirmed_no_prescription.alternate_third_wiring_architecture_only`: 1
- `terminal.confirmed_no_prescription.ambient_intensity_ratio_control_only`: 1
- `terminal.confirmed_no_prescription.animal_motion_exposure_control_computer_readable_medium_wrapper_only`: 1
- `terminal.confirmed_no_prescription.animal_motion_exposure_control_electronic_device_architecture_only`: 1
- `terminal.confirmed_no_prescription.animal_motion_exposure_control_method_only`: 1
- `terminal.confirmed_no_prescription.annular_coupling_shape_variant_only`: 1
- `terminal.confirmed_no_prescription.ar_glasses_wrapper_only`: 1
...
- `terminal.confirmed_no_prescription.autonomous_vehicle_projection_wrapper_only`: 1
...
- `terminal.confirmed_no_prescription.barrel_fit_blocking_film_integration_only`: 1
- `terminal.confirmed_no_prescription.baseline_low_parallax_objective_schematic_only`: 1
- `terminal.confirmed_no_prescription.beam_split_multimodal_channel_architecture_only`: 1
- `terminal.confirmed_no_prescription.cabin_dual_camera_scanning_architecture_only`: 1
- `terminal.confirmed_no_prescription.cabin_single_tele_scanning_architecture_only`: 1
...
- `terminal.confirmed_no_prescription.camera_unit_antenna_radiator_architecture_only`: 1
- `terminal.confirmed_no_prescription.cascaded_multi_lens_coupling_architecture_only`: 1
- `terminal.confirmed_no_prescription.claimed_coherent_imaging_system_architecture_only`: 1
- `terminal.confirmed_no_prescription.color_vision_deficiency_transformation_model_method_only`: 1
- `terminal.confirmed_no_prescription.colorblind_image_rendering_machine_readable_medium_only`: 1
- `terminal.confirmed_no_prescription.colorblind_image_rendering_method_only`: 1
- `terminal.confirmed_no_prescription.colorblind_image_rendering_system_architecture_only`: 1
- `terminal.confirmed_no_prescription.commercial_camera_lens_lab_results_only`: 1
- `terminal.confirmed_no_prescription.comparative_lens_architecture_only`: 1
- `terminal.confirmed_no_prescription.composite_photography_system_wrapper_only`: 1
...
- `terminal.confirmed_no_prescription.curable_composition_film_filter_and_sensor_materials_only`: 1
- `terminal.confirmed_no_prescription.data_capture_device_weigh_platter_power_storage_architecture_only`: 1
- `terminal.confirmed_no_prescription.direct_primary_plane_sensor_architecture_only`: 1
- `terminal.confirmed_no_prescription.discrete_coupling_position_variant_only`: 1
- `terminal.confirmed_no_prescription.dual_axis_camera_drive_architecture_only`: 1
- `terminal.confirmed_no_prescription.dual_camera_steering_scanning_architecture_only`: 1
...
- `terminal.confirmed_no_prescription.fifth_embodiment_folded_telephoto_smartphone_wrapper_only`: 1
- `terminal.confirmed_no_prescription.fifth_spiral_protrusion_lens_element_example_only`: 1
...
- `terminal.confirmed_no_prescription.first_configuration_open_arc_variant_only`: 1
- `terminal.confirmed_no_prescription.first_configuration_parallel_multi_ring_variant_only`: 1
- `terminal.confirmed_no_prescription.first_configuration_preferred_heating_architecture_only`: 1
...
- `terminal.confirmed_no_prescription.first_embodiment_first_light_blocking_structure_example_only`: 1
- `terminal.confirmed_no_prescription.first_embodiment_second_light_blocking_structure_example_only`: 1
- `terminal.confirmed_no_prescription.first_embodiment_third_light_blocking_structure_example_only`: 1
- `terminal.confirmed_no_prescription.first_spiral_protrusion_lens_element_example_only`: 1
- `terminal.confirmed_no_prescription.flash_lidar_channel_architecture_only`: 1
- `terminal.confirmed_no_prescription.flexible_wire_plate_driving_architecture_only`: 1
- `terminal.confirmed_no_prescription.folded_dual_camera_architecture_wrapper_only`: 1
- `terminal.confirmed_no_prescription.folded_passive_poc_mirror_architecture_only`: 1
- `terminal.confirmed_no_prescription.folded_reflector_light_blocking_compensation_architecture_only`: 1
- `terminal.confirmed_no_prescription.four_prism_light_dividing_architecture_only`: 1
- `terminal.confirmed_no_prescription.fourth_embodiment_multi_camera_smartphone_wrapper_only`: 1
- `terminal.confirmed_no_prescription.fourth_lens_carrier_wiring_architecture_only`: 1
- `terminal.confirmed_no_prescription.fourth_spiral_protrusion_lens_element_example_only`: 1
- `terminal.confirmed_no_prescription.fourth_variable_aperture_drive_architecture_only`: 1
...
- `terminal.confirmed_no_prescription.full_light_field_camera_architecture_only`: 1
- `terminal.confirmed_no_prescription.full_light_field_imaging_method_only`: 1
...
- `terminal.confirmed_no_prescription.generic_eight_lens_architecture_only`: 1
- `terminal.confirmed_no_prescription.generic_folded_imaging_lens_assembly_architecture_only`: 1
- `terminal.confirmed_no_prescription.generic_imaging_apparatus_wrapper_only`: 1
- `terminal.confirmed_no_prescription.generic_one_group_pop_out_architecture_only`: 1
- `terminal.confirmed_no_prescription.generic_seven_lens_architecture_only`: 1
- `terminal.confirmed_no_prescription.generic_small_scale_imaging_optic_architecture_only`: 1
- `terminal.confirmed_no_prescription.grin_metamaterial_polarimetric_lens_architecture_only`: 1
- `terminal.confirmed_no_prescription.ground_glass_full_light_field_device_architecture_only`: 1
- `terminal.confirmed_no_prescription.head_mounted_projection_device_architecture_only`: 1
- `terminal.confirmed_no_prescription.head_up_display_system_wrapper_only`: 1
- `terminal.confirmed_no_prescription.highest_power_density_system_architecture_only`: 1
- `terminal.confirmed_no_prescription.image_capturing_apparatus_wrapper_only`: 1
- `terminal.confirmed_no_prescription.image_module_wrapper_only`: 1
...
- `terminal.confirmed_no_prescription.inner_passive_poc_spring_architecture_only`: 1
...
- `terminal.confirmed_no_prescription.laser_projection_system_architecture_only`: 1
- `terminal.confirmed_no_prescription.laser_safety_aiming_constraint_only`: 1
- `terminal.confirmed_no_prescription.lens_and_camera_setting_selection_process_only`: 1
- `terminal.confirmed_no_prescription.lens_calibration_computing_architecture_only`: 1
- `terminal.confirmed_no_prescription.lens_characterization_decode_performance_process_only`: 1
- `terminal.confirmed_no_prescription.lens_chassis_assembly_architecture_only`: 1
- `terminal.confirmed_no_prescription.lens_module_manufacturing_method_only`: 1
...
- `terminal.confirmed_no_prescription.merit_function_lens_design_method_only`: 1
- `terminal.confirmed_no_prescription.microscopy_full_light_field_device_architecture_only`: 1
- `terminal.confirmed_no_prescription.mobile_device_multi_camera_wrapper_only`: 1
- `terminal.confirmed_no_prescription.mobile_transportation_camera_module_architecture_only`: 1
- `terminal.confirmed_no_prescription.monocentric_transmitter_performance_model_only`: 1
- `terminal.confirmed_no_prescription.motor_on_autofocus_compensation_variant_only`: 1
- `terminal.confirmed_no_prescription.motorized_camera_setting_calibration_system_only`: 1
- `terminal.confirmed_no_prescription.mtf_defocus_staged_alignment_method_only`: 1
- `terminal.confirmed_no_prescription.multi_camera_mounting_and_opto_mechanical_architecture_only`: 1
- `terminal.confirmed_no_prescription.multi_camera_timing_exposure_control_computer_readable_medium_wrapper_only`: 1
- `terminal.confirmed_no_prescription.multi_camera_timing_exposure_control_electronic_device_architecture_only`: 1
- `terminal.confirmed_no_prescription.multi_camera_timing_exposure_control_operating_method_only`: 1
- `terminal.confirmed_no_prescription.multi_view_projection_optical_machine_architecture_only`: 1
- `terminal.confirmed_no_prescription.multicompressor_objective_partial_values_only`: 1
- `terminal.confirmed_no_prescription.multiwire_sma_actuator_architecture_only`: 1
- `terminal.confirmed_no_prescription.near_ir_absorbing_polymer_and_cut_filter_materials_only`: 1
- `terminal.confirmed_no_prescription.negative_spherical_aberration_lens_assembly_architecture_only`: 1
- `terminal.confirmed_no_prescription.neutral_density_long_range_first_order_parameters_only`: 1
- `terminal.confirmed_no_prescription.neutral_density_range_compensating_lens_schematic_only`: 1
- `terminal.confirmed_no_prescription.notebook_camera_antenna_module_wrapper_only`: 1
- `terminal.confirmed_no_prescription.off_axis_nonimaging_dual_power_lens_schematic_only`: 1
- `terminal.confirmed_no_prescription.on_axis_dual_power_lens_schematic_only`: 1
- `terminal.confirmed_no_prescription.onboard_apparatus_wrapper_only`: 1
- `terminal.confirmed_no_prescription.one_point_five_x_objective_relay_schematic_only`: 1
- `terminal.confirmed_no_prescription.opa_lidar_channel_architecture_only`: 1
- `terminal.confirmed_no_prescription.optical_alignment_and_assembly_method_only`: 1
- `terminal.confirmed_no_prescription.outer_passive_poc_gear_architecture_only`: 1
- `terminal.confirmed_no_prescription.outer_passive_poc_magnetic_spring_architecture_only`: 1
- `terminal.confirmed_no_prescription.paired_target_inclination_compensation_variant_only`: 1
...
- `terminal.confirmed_no_prescription.portable_terminal_apparatus_wrapper_only`: 1
- `terminal.confirmed_no_prescription.primary_pair_point_contact_alignment_architecture_only`: 1
- `terminal.confirmed_no_prescription.projection_headlight_wrapper_only`: 1
- `terminal.confirmed_no_prescription.projection_method_only`: 1
...
- `terminal.confirmed_no_prescription.range_compensating_lens_assembly_architecture_only`: 1
- `terminal.confirmed_no_prescription.range_compensating_lens_design_method_only`: 1
- `terminal.confirmed_no_prescription.range_finding_system_architecture_only`: 1
- `terminal.confirmed_no_prescription.relaxed_long_range_first_order_radiometric_variant_only`: 1
- `terminal.confirmed_no_prescription.resilience_wiring_sheet_driving_architecture_only`: 1
- `terminal.confirmed_no_prescription.resin_composition_molded_product_and_optical_component_materials_only`: 1
- `terminal.confirmed_no_prescription.restoration_imaging_and_manufacturing_architecture_only`: 1
- `terminal.confirmed_no_prescription.scanning_stitched_image_processing_wrapper_only`: 1
...
- `terminal.confirmed_no_prescription.second_configuration_manufacturing_method_only`: 1
- `terminal.confirmed_no_prescription.second_configuration_preferred_conductive_contact_architecture_only`: 1
- `terminal.confirmed_no_prescription.second_configuration_split_conductive_element_variant_only`: 1
- `terminal.confirmed_no_prescription.second_configuration_thermal_insulator_variant_only`: 1
- `terminal.confirmed_no_prescription.second_embodiment_first_light_blocking_structure_example_only`: 1
- `terminal.confirmed_no_prescription.second_embodiment_second_light_blocking_structure_example_only`: 1
- `terminal.confirmed_no_prescription.second_flexible_wire_plate_drive_architecture_only`: 1
- `terminal.confirmed_no_prescription.second_spiral_protrusion_lens_element_example_only`: 1
- `terminal.confirmed_no_prescription.short_range_first_order_radiometric_parameters_only`: 1
- `terminal.confirmed_no_prescription.single_tele_steering_scanning_architecture_only`: 1
- `terminal.confirmed_no_prescription.sixth_embodiment_vehicle_camera_placement_wrapper_only`: 1
...
- `terminal.confirmed_no_prescription.split_lens_camera_module_architecture_only`: 1
- `terminal.confirmed_no_prescription.split_lens_six_degree_positioning_method_only`: 1
...
- `terminal.confirmed_no_prescription.stop_adjacent_lens_group_system_architecture_only`: 1
- `terminal.confirmed_no_prescription.stress_birefringence_merit_function_lens_design_method_only`: 1
- `terminal.confirmed_no_prescription.stress_birefringence_one_or_more_group_lens_design_method_only`: 1
- `terminal.confirmed_no_prescription.stress_birefringence_two_group_lens_design_method_only`: 1
- `terminal.confirmed_no_prescription.sub_lens_fixation_process_variants_only`: 1
- `terminal.confirmed_no_prescription.substitution_lens_design_method_only`: 1
- `terminal.confirmed_no_prescription.surveillance_scanning_and_fusion_architecture_only`: 1
- `terminal.confirmed_no_prescription.target_surface_field_curvature_matching_variant_only`: 1
- `terminal.confirmed_no_prescription.terminal_device_wrapper_only`: 1
- `terminal.confirmed_no_prescription.third_camera_drive_architecture_only`: 1
- `terminal.confirmed_no_prescription.third_embodiment_light_blocking_structure_example_only`: 1
- `terminal.confirmed_no_prescription.third_spiral_protrusion_lens_element_example_only`: 1
- `terminal.confirmed_no_prescription.third_variable_aperture_drive_architecture_only`: 1
- `terminal.confirmed_no_prescription.tonometer_pupil_tracking_wrapper_only`: 1
- `terminal.confirmed_no_prescription.two_x_coherent_objective_relay_partial_values_only`: 1
- `terminal.confirmed_no_prescription.unidentified_zemax_fisheye_performance_model_only`: 1
- `terminal.confirmed_no_prescription.unmanned_aerial_vehicle_camera_module_wrapper_only`: 1
- `terminal.confirmed_no_prescription.variable_length_camera_module_and_portable_terminal_wrapper_only`: 1
- `terminal.confirmed_no_prescription.vehicle_camera_placement_and_visual_angle_wrapper_only`: 1
- `terminal.confirmed_no_prescription.vehicle_camera_placement_wrapper_only`: 1
- `terminal.confirmed_no_prescription.vehicle_dual_camera_scanning_opfe_architecture_only`: 1
- `terminal.confirmed_no_prescription.vehicle_head_up_display_wrapper_only`: 1
- `terminal.confirmed_no_prescription.vehicle_multi_camera_module_wrapper_only`: 1
...
- `terminal.metadata_unpublished.absolute_image_height_absent_and_table3a_abbe_outside_physical_bounds`: 1
- `terminal.metadata_unpublished.angular_field_half_full_semantics_and_exact_stop_coordinate_absent`: 1
...
- `terminal.metadata_unpublished.first_example_stop_axial_coordinate_absent`: 1
- `terminal.metadata_unpublished.imaging_lens_100a_stop_axial_coordinate_absent`: 1
- `terminal.metadata_unpublished.imaging_lens_100b_stop_axial_coordinate_absent`: 1
- `terminal.metadata_unpublished.imaging_lens_100c_stop_axial_coordinate_absent`: 1
- `terminal.metadata_unpublished.imaging_lens_100d_stop_axial_coordinate_absent`: 1
- `terminal.metadata_unpublished.prescription_specific_angular_field_absent_and_surface_radius_conflict_table_12_1_12_2`: 1
- `terminal.metadata_unpublished.prescription_specific_efl_f_number_angular_field_and_image_height_absent`: 1
- `terminal.metadata_unpublished.prescription_specific_stop_surface_position_absent_and_asphere_a24_malformed`: 1
- `terminal.metadata_unpublished.prescription_specific_stop_surface_position_absent_and_image_height_conflicting`: 1
- `terminal.metadata_unpublished.qcon_q6_q10_basis_definitions_and_surface_index_mapping_absent`: 1
- `terminal.metadata_unpublished.qcon_q6_q11_basis_definitions_absent`: 1
- `terminal.metadata_unpublished.qcon_q6_q7_basis_definitions_and_system_stop_absent`: 1
...
- `terminal.metadata_unpublished.system_angular_field_and_final_axial_distances_absent`: 1
...
- `other_finite_object_state_is_published_but_unsupported_by_the_infinity_conjugate_replay_model_object_distance_n_mm`: 20
...
- `other_four_lens_eight_embodiment_asphere_table_label_token_confidence_n_is_below_n`: 1
- `other_four_lens_eight_embodiment_asphere_table_label_token_has_n_exact_ocr_tokens_expected_n`: 1
- `other_four_lens_eight_embodiment_optical_table_label_token_confidence_n_is_below_n_four_lens_eight_embodiment_asp_52ff229725fd`: 1
...
- `other_optical_metadata_label_efl_has_n_exact_ocr_prefixes_four_lens_eight_embodiment_asphere_table_label_token_co_a8d3cbdfcb16`: 1
- `other_optical_metadata_label_efl_has_n_exact_ocr_prefixes_four_lens_eight_embodiment_asphere_table_label_token_ha_0e7d3d99bac3`: 1
...
- `other_optical_metadata_label_hfov_has_n_exact_ocr_prefixes_four_lens_eight_embodiment_asphere_table_label_token_c_50eb8e024978`: 1
- `other_optical_metadata_label_hfov_has_n_exact_ocr_prefixes_four_lens_eight_embodiment_asphere_table_label_token_c_c35191a975b7`: 1
- `other_optical_metadata_label_hfov_has_n_exact_ocr_prefixes_four_lens_eight_embodiment_asphere_table_label_token_h_8a3cef9af5b5`: 1
...
- `other_published_focus_tunable_component_focal_length_infinity_at_object_distance_n_mm_cannot_be_represented_by_th_6db90aeb15e3`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_infinity_cannot_be_represented_by_th_da23ff40dcf2`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_n_mm_cannot_be_represented_by_the_cu_3e82ce392742`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_n_mm_cannot_be_represented_by_the_cu_7e98dc125f03`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_n_mm_cannot_be_represented_by_the_cu_8fa1ea13cbe2`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_n_mm_cannot_be_represented_by_the_cu_973d2d4ea922`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_n_mm_cannot_be_represented_by_the_cu_bae2cad9f6fa`: 1
- `other_published_focus_tunable_component_focal_length_n_mm_at_object_distance_n_mm_cannot_be_represented_by_the_cu_dfaa24798e5d`: 1
...
- `other_published_table_n_nonzero_odd_power_radial_asphere_terms_a3_a5_a7_a9_a11_a13_a15_a17_a19_on_surfaces_n_n_n_3e5f0df7426d`: 1
- `other_published_table_n_nonzero_odd_power_radial_asphere_terms_a3_a5_a7_a9_a11_a13_a15_a17_a19_on_surfaces_n_n_n_f0fa78fc9732`: 1
- `other_published_table_n_nonzero_odd_power_radial_asphere_terms_a3_a5_a7_a9_a11_a13_a15_a17_a19_on_surfaces_n_n_n_f57cfabe3f28`: 1
...
- `other_system_n_table_n_publishes_a_n_mm_finite_object_and_a_decenter_n_coordinate_break_with_z_n_mm_patentsurface_65853f9e4cf0`: 1
