...
- `parser_review_required.all_disclosed_items_rejected`: 316
- `mixed_nonterminal.multiple_item_states`: 146
- `terminal.all_disclosed_items_terminal`: 132
